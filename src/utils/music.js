...
const audioFiles = [
    new URL("../assets/music/Aria_Math_-_C418--.ogg", import.meta.url).href,
    new URL("../assets/music/Kyoto_-_C418--.ogg", import.meta.url).href,
    new URL("../assets/music/Mutation_-_C418--.ogg", import.meta.url).href
];
